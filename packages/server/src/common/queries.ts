...
// TB_SQL_HIST
export const querySqlStat = `SELECT H.SNAP_ID, BEGIN_INTERVAL_TIME,END_INTERVAL_TIME,H.DBID,H.INSTANCE_NUMBER,SQL_ID,
...
export const querySqlText = `SELECT DBID, SQL_ID, SQL_TEXT FROM DBA_HIST_SQLTEXT`;
// S
